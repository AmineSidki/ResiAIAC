...
public class SeaweedFsServiceImpl implements SeaweedFsService {
    ...
    public String getFileUrl(String bucketName, String fileName, int expiry) {
        if(!bucketExists(bucketName)) throw new BucketNotFoundException("No such bucket : " + bucketName);
        GetObjectRequest request = GetObjectRequest.builder()
                .bucket(bucketName)
                .key(fileName)
                .build();

        GetObjectPresignRequest requestPresignRequest = GetObjectPresignRequest.builder()
