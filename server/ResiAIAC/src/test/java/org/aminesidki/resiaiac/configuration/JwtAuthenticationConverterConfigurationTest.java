...
class JwtAuthenticationConverterConfigurationTest {
    ...
    void returnsNoAuthoritiesWhenRealmAccessHasNoRolesEntry() {
        ...
        assertThat(converter.convert(jwt).getAuthorities()).doesNotContainAnyElementsOf(List.of(new SimpleGrantedAuthority("ROLE_ADMINISTRATEUR"),new SimpleGrantedAuthority("ROLE_RESPONSABLE"),new SimpleGrantedAuthority("ROLE_MANAGER"), new SimpleGrantedAuthority("ROLE_ETUDIANT")));
    }
}