...
\begin{tikzpicture}[>=stealth]
  ...
  \node[depnode=yellow!22, text width=2.3cm] (minio) at (3.1,0.0) {\faDatabase\ SeaweedFS\\(Stockage Objet)};
  ...
  \node[depnode=red!12, text width=2.6cm] (logstash) at (9.2,0.0) {\faListAlt\ Logstash\\(Agrégation de Logs)};
